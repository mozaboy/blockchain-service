...
public class BigDecimalUtil {
     ...
     * @return
     */
    public static BigDecimal div1(BigDecimal d1, BigDecimal d2, int scale)
    {
        //  要判断分母是否为0?
        BigDecimal bd1 = d1;
        BigDecimal bd2 = d2;
        BigDecimal a = d1.divide(d2, scale, BigDecimal.ROUND_FLOOR);
        return a;
    }
     ...
     * @return
     */
    public static BigDecimal inputConvert(Double value)
    {
